...
The project was created to enforce simple and practical Makefile conventions while keeping the rules configurable and easy to evolve.

## ✨ Features

Current features planned for the initial version:
...
* Keep the extension modular and easy to extend.
